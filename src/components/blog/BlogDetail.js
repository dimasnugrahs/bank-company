...
const BlogDetail = () => {
  ...
  return (
    <div className="gap-0 items-center py-8 px-6 mx-auto max-w-screen-xl lg:grid lg:grid-cols-1 lg:py-16 lg:px-6">
      ...
      <div className="font-light  sm:text-lg text-gray-400 ">
        <section className="bg-white ">
          {Array.isArray(blog.images) && blog.images.length > 0 && (
            <div className="flex justify-center items-center py-8 px-6 mx-auto max-w-screen-xl">
              <img
