      ...
      <section className="bg-white ">
        <div className="gap-16 items-center py-8 px-6 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light  sm:text-lg text-gray-400 ">
            <h2 className="font-barlow-condensed mb-4 text-3xl tracking-tight font-extrabold text-gray-900 ">
              Fleksibilitas, Inovasi dan kepercayaan
            </h2>
            <p className="font-barlow-condensed mb-4 text-gray-600 mt-4 leading-relaxed text-justify lg:text-left">
            ...
            <p className="font-barlow-condensed text-gray-600 mt-4 leading-relaxed text-justify lg:text-left">
