    ...
    <div className="gap-16 items-center py-8 px-6 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      <div className="font-light  sm:text-lg text-gray-400 ">
        ...
        <p className=" mb-4 text-gray-600 mt-4 leading-relaxed text-justify lg:text-left">
          ...
          layanan perbankan dan penyedia solusi keuangan. Cukup fleksibel untuk
          memenuhi kebutuhan harian Anda, namun cukup kuat untuk mendukung
          impian besar Anda.
        </p>
        <p className=" text-gray-600 mt-4 leading-relaxed text-justify lg:text-left">
          Bank Lorem Ipsum hadir dengan layanan yang sederhana, cepat, dan mudah
          diakses, namun tetap berkomitmen untuk memberikan solusi keuangan yang
          lengkap dan komprehensif, sesuai dengan skala kebutuhan Anda.
        </p>
      </div>
